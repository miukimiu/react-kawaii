...
export const Face: FunctionComponent<KawaiiFaceProps> = ({ mood = 'blissful', uniqueId, transform, ...rest }) => (
  <g id="kawaii-face" transform={transform} {...rest}>
    ...
    <g id="kawaii-face__mouth" transform="translate(18.000000, 16.000000)">
      ...
      {mood === 'happy' && <path d={paths.happy} id="kawaii-face__mouth__happy" fill="#000000" />}
      {mood === 'shocked' && <ellipse id="kawaii-face__mouth__shocked" cx="15" cy="14" rx="9" ry="10" fill="#000000" />}
      {(mood === 'sad' || mood === 'ko') && (
        <path
          d={paths.sad}
    ...
    <g id="kawaii-face__eyes" transform="translate(2.000000, 0.000000)" fill="#000000">
      ...
      {(mood === 'happy' || mood === 'sad' || mood === 'shocked' || mood === 'excited') && (
        <g id="kawaii-face__eyes__circle" transform="translate(1.000000, 2.000000)">
          <circle cx="4.5" cy="4.5" r="4.5" />
          <circle cx="56.5" cy="4.5" r="4.5" />
        </g>
      )}
      {mood === 'lovestruck' && (
        <g id="kawaii-face__eyes__heart" transform="translate(0.000000, 2.000000)" fillRule="nonzero">
          <path d={paths.lovestruck1} id="Shape" />
          <path d={paths.lovestruck2} id="Shape" />
        </g>
      )}
      {mood === 'ko' && (
        <g id="kawaii-face__eyes__ko" transform="translate(1.500000, 1.000000)" fillRule="nonzero">
