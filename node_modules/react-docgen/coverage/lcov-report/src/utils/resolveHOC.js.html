...
<html lang="en">
<head>
    <title>Code coverage report for src/utils/resolveHOC.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/utils</a> resolveHOC.js
    </h1>
    <div class='clearfix'>
...
export default function resolveHOC(path: NodePath): NodePath {
  ...
  if (types.CallExpression.check(node) &amp;&amp; !isReactCreateClassCall(path)) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (node.arguments.length) {
